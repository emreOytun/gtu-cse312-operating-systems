...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        class InterruptManager
        {
            ...
            protected:
                // For hardware to access the InterruptManager, it should be static. So, we are keeping a static InterruptHandler variable here
                // like a singleton pattern.
                static InterruptManager* ActiveInterruptManager;
                InterruptHandler* handlers[256];
                TaskManager *taskManager;

                // InterruptDescriptorTable keeps entries of GateDescriptor. 
                // An entry keeps address to handler which keeps interrupt number, handler for this interrupt.
                // It also keeps gdt segment, access bits.
                ...
                struct InterruptDescriptorTablePointer
                {
                    ...
                    myos::common::uint32_t base; // The address of the InterruptDescriptorTable
                } __attribute__((packed));
                ...
                // The static functions below are implemented in interruptstubs.s by calling the macros in there.
                ...
                // From PiCs(Programmable Interrupt Controllers), CPU get the interrupt number and finds the handler from InterruptDescriptorTable
